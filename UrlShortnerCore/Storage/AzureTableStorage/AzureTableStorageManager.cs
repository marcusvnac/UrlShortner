...
namespace ShortherUrlCore.Storage.AzureTableStorage
{
    public class AzureTableStorageManager : IStorageManager
    {
        ...
        {
            this.connectionString = Configuration.GetConnectionString("AzureTableStorage") ?? throw new ArgumentNullException(nameof(Configuration), "AzureTableStorage connection string is null");
